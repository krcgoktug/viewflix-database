-- STREAMFLIX - Online SQL siteleri icin (db-fiddle.com, sqliteonline.com)
-- CREATE DATABASE / USE satirlari cikarildi. Tek parca: once tablolar, sonra veriler.
...
-- ============================================================
--  STREAMFLIX  -  02 - ORNEK VERILER
--  Toplam 280+ kayit, tablolara dagitilmis
--  Calistirma sirasi: 01_create_tables.sql -> bu dosya
-- ============================================================
...
(1,'Basic',7.99,'720p',1,'Tek ekran, HD kalitesinde izleme'),
(2,'Standard',13.99,'1080p',2,'Iki ekran, Full HD kalitesinde izleme'),
(3,'Premium',19.99,'4K',4,'Dort ekran, 4K Ultra HD ve HDR destekli');
...
(2,1,'Cocuk',TRUE,2,'2024-01-16 09:00:00'),
...
(20,14,'Spor',FALSE,2,'2024-05-26 10:00:00'),
(21,15,'Anna',FALSE,3,'2025-01-05 10:05:00'),
(22,1,'Misafir',FALSE,1,'2024-06-01 11:00:00'),
...
(1,'Inception','Movie',2010,'Ruyalar icinde calinan sirlar.','PG-13',1,8.8,'2024-01-01'),
(2,'The Dark Knight','Movie',2008,'Batman ve Joker arasindaki mucadele.','PG-13',1,9.0,'2024-01-01'),
(3,'Parasite','Movie',2019,'Iki ailenin sinifsal catismasi.','R',6,8.5,'2024-01-05'),
(4,'Amelie','Movie',2001,'Parisli bir kizin masum maceralari.','R',4,8.3,'2024-01-10'),
(5,'Pans Labyrinth','Movie',2006,'Savas doneminde bir kizin fantastik dunyasi.','R',5,8.2,'2024-01-12'),
(6,'Spirited Away','Movie',2001,'Ruhlar dunyasinda kaybolan bir kiz.','PG',7,8.6,'2024-01-15'),
(7,'The Matrix','Movie',1999,'Gercekligin sorgulandigi bir dijital dunya.','R',1,8.7,'2024-01-20'),
(8,'Interstellar','Movie',2014,'Insanligi kurtarmak icin uzay yolculugu.','PG-13',1,8.6,'2024-01-22'),
(9,'Whiplash','Movie',2014,'Bir muzisyenin mukemmellik arayisi.','R',1,8.5,'2024-02-01'),
(10,'Your Name','Movie',2016,'Iki gencin beden degistiren baglantisi.','PG',7,8.4,'2024-02-05'),
(11,'Breaking Bad','Series',2008,'Bir kimya ogretmeninin suc dunyasina dususu.','TV-MA',1,9.5,'2024-01-02'),
(12,'Stranger Things','Series',2016,'Kucuk bir kasabadaki dogaustu olaylar.','TV-14',1,8.7,'2024-01-03'),
(13,'Dark','Series',2017,'Zaman yolculugu ve kayip cocuklar gizemi.','TV-MA',3,8.7,'2024-01-08'),
(14,'Money Heist','Series',2017,'Buyuk bir soygun planinin hikayesi.','TV-MA',5,8.2,'2024-01-11'),
(15,'Squid Game','Series',2021,'Olumcul oyunlarda hayatta kalma mucadelesi.','TV-MA',6,8.0,'2024-01-18'),
(16,'The Crown','Series',2016,'Ingiltere kraliyet ailesinin oykusu.','TV-MA',1,8.6,'2024-02-02'),
(17,'Sherlock','Series',2010,'Modern Londrada dahi dedektif.','TV-14',1,9.1,'2024-02-08'),
(18,'Game of Thrones','Series',2011,'Taht icin verilen amansiz savaslar.','TV-MA',1,9.2,'2024-02-12'),
(19,'Black Mirror','Series',2011,'Teknolojinin karanlik yuzu.','TV-MA',1,8.7,'2024-02-15'),
(20,'The Witcher','Series',2019,'Canavar avcisi Geraltin maceralari.','TV-MA',1,8.0,'2024-02-20');
...
(1,1,11,10,'Tum zamanlarin en iyi dizisi!','2024-02-05 22:00:00'),
(2,1,8,9,'Gorsel olarak mukemmel, sonu beni agirtti.','2024-02-11 21:00:00'),
(3,3,2,10,'Heath Ledger efsane bir Joker.','2024-02-07 20:00:00'),
(4,3,7,8,'Hala etkileyici bir klasik.','2024-02-10 19:00:00'),
(5,5,13,9,'Cok karmasik ama odul gibi bir izleme deneyimi.','2024-02-14 21:00:00'),
(6,5,17,10,'Her bolum tam bir bulmaca.','2024-02-16 20:00:00'),
(7,6,1,9,'Zihin acici bir film.','2024-03-07 19:00:00'),
(8,8,6,10,'Miyazaki sahaneydi.','2024-03-17 18:00:00'),
(9,9,4,8,'Tatli ve renkli bir film.','2024-03-24 17:00:00'),
(10,10,3,9,'Beklenmedik bir sonu var.','2024-04-04 20:00:00'),
(11,10,15,7,'Iyiydi ama abartildi.','2024-04-06 19:00:00'),
(12,12,11,10,'Walter Whitein donusumu inanilmaz.','2024-04-15 22:00:00'),
(13,14,8,9,'Bilim ve duygu bir arada.','2024-05-05 21:00:00'),
(14,14,19,8,'Bazi bolumler dahice.','2024-05-06 22:00:00'),
(15,15,14,8,'Gerilim hic dusmuyor.','2024-05-12 20:00:00'),
(16,18,10,9,'Cok duygusal bir anime.','2024-05-23 19:00:00'),
(17,19,11,10,'Tekrar tekrar izlenir.','2024-06-01 21:00:00'),
(18,21,9,9,'Muzik ve gerilim mukemmel.','2025-01-07 20:00:00'),
(19,5,12,7,'Nostaljik ve eglenceli.','2024-02-20 21:00:00'),
(20,3,18,9,'Destansi bir yapim.','2024-02-12 22:00:00');
...
(15,14,'TV','Vestel Salon','2024-05-26 15:00:00'),
